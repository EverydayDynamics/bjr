...
use central_control_firmware as _; // global logger + panicking-behavior + memory layout
...
mod app {
    use board_support_package;
    use board_support_package::boards::BoardCreationError;
    ...
    async fn task1(_cx: task1::Context) {
        ...
        let timer_clock_hz = 75_000_000; // Yeah don't know why I need this part
