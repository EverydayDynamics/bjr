...
impl RunnableState for DefaultStateRunner {
    ...
    fn update(&mut self, _iomanager: &mut dyn IOManager, _call_time: Microseconds<u64>, _event_queue: EventQueue, logger: &mut dyn Logger, _command: &StateRunnerCommand) -> Result<(),StateRunnerError> {
        Ok(())
    }
