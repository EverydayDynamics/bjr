...
use crate::app::control::setpoint_generator::{
    SetPointGen3Point, SetPointGenCH, SetPointGenCircling,
};
...
impl DefaultStateRunnerSelector {
    pub fn new() -> Self {
        DefaultStateRunnerSelector {
            ...
            center_hold_control_runner: StateRunnerWrapper::CenterHoldControl(
                ControlStateRunner::new(PIDController::default(), FFGenCH {}, SetPointGenCH {}),
            ),
            ...
            point_3_control_runner: StateRunnerWrapper::Point3Control(ControlStateRunner::new(
                PIDController::default(),
                FFGenCH {},
