...
use crate::app::parameter_manager::{parameter_manager, MCPosDeadBand};
use crate::app::parameter_manager::{MCAccel, MCKp};
use libm::fabsf;
...
impl Default for MotorController {
    fn default() -> Self {
        MotorController {
            vel_limit: MotorControlVelLimit::new(LimitLevel::Clamp),
        }
    }
}
